...
switch (argv[2]) {
    ...
    case 'ayuda': // Descripción de las acciones disponibles.
        ...
        console.log(`TAREAS: \n\nLa acción "tareas" muestra el total de tareas disponibles en nuestro array de objetos literales.\nSe accede con el comando [node app tareas"]\n`);
        console.log(`ESTADO:\n\nLa acción "estado" permite filtrar las tareas por su estado y mostrarlas por terminal.\nSe accede con el comando [node app estado + "estado"]\n`);
        console.log(`CATEGORIAS:\n\nLa acción "categoria" permite filtrar las tareas por su categoría y mostrarlas por terminal.\nSe accede con el comando [node app estado + "categorias"]\n`);
        console.log(`CATEGORIAS-F:\n\nLa acción "categoria-f" permite filtrar las tareas por su categorías y mostrarlas por terminal.\nSe accede con el comando [node app estado + "categorias-f"]\n`);
        ...
        console.log(`NUEVO-TITULO:\n\nLa acción "nuevo-titulo" permite modificar el titulo de una tarea indicando su posición y el nombre del nuevo titulo.\nSe accede con el comando [node app nuevo-titulo + posicion + nuevo titulo].\nRecomendación: Listar previamente las tareas para corroborar la posición de las tareas antes de modificar el titulo de las mismas.\n`);
        console.log(`NUEVA-CATEGORÍA:\n\nLa acción "nueva-categoria" permite modificar la categoría de una tarea indicando su posición y el nombre de la nueva categoría.\nSe accede con el comando [node app nueva-categoria + posicion + nueva categoria].\nRecomendación: Listar previamente las tareas para corroborar la posición de las tareas antes de modificar la categoría de las mismas.\n`);
